...
let virtual-env = "D:\Учёба\Учёба\ИТМО\1-й курс\Программирование\item_shop\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Учёба\Учёба\ИТМО\1-й курс\Программирование\item_shop\venv\Scripts\deactivate.nu"
